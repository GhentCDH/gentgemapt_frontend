<template>
  <div class="place-info" v-if="placeId">
    ...
    <div class="place-info-content">
      ...
      <gm-iiif-image-gallery :manifestUri="manifestUri" :key="manifestUri"></gm-iiif-image-gallery>
    </div>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    manifestUri() {
      return 'https://iiif.ghentcdh.ugent.be/iiif/manifests/zichtenopgent:' + this.data['dcterms:identifier'][0]['@value'].replace('http://www.gentgemapt.be/place/','');
    }
  },
  methods: {
