"use strict";
(self["webpackChunkgent_gemapt"] = self["webpackChunkgent_gemapt"] || []).push([[264],{
...
__webpack_require__.d(__webpack_exports__, {
  "default": function() { return /* binding */ containers_GalleryView; }
});
...
var actions_canvas = __webpack_require__(44776);
// EXTERNAL MODULE: ./node_modules/mirador/dist/es/src/state/actions/index.js
var actions = __webpack_require__(34364);
...
/* harmony default export */ var Person = ((0,createSvgIcon/* default */.c)( /*#__PURE__*/react.createElement("path", {
...
var Avatar = /*#__PURE__*/react.forwardRef(function Avatar(props, ref) {
  var alt = props.alt,
    ...
    other = (0,objectWithoutProperties/* default */.c)(props, ["alt", "children", "classes", "className", "component", "imgProps", "sizes", "src", "srcSet", "variant"]);
  ...
  if (hasImgNotFailing) {
    children = /*#__PURE__*/react.createElement("img", (0,esm_extends/* default */.c)({
      alt: alt,
      src: src,
      srcSet: srcSet,
      sizes: sizes,
 ...
 false ? 0 : void 0;
/* harmony default export */ var Avatar_Avatar = ((0,withStyles/* default */.c)(styles, {
  name: 'MuiAvatar'
})(Avatar));
...
var IIIFThumbnail = __webpack_require__(37528);
...
var GalleryViewThumbnail = /*#__PURE__*/function (_Component) {
  ...
  _createClass(GalleryViewThumbnail, [{
    ...
    value: function render() {
      ...
      var miradorCanvas = new MiradorCanvas/* default */.c(canvas);
      return /*#__PURE__*/react.createElement(lib_es/* default */.cp, {
        ...
        role: "button",
        tabIndex: 0
      }, /*#__PURE__*/react.createElement(IIIFThumbnail/* default */.c, {
        resource: canvas,
        labelled: true,
        variant: "outside",
      ...
      }, searchAnnotationsCount > 0 && /*#__PURE__*/react.createElement(Chip/* default */.c, {
        avatar: /*#__PURE__*/react.createElement(Avatar_Avatar, {
          className: classes.avatar,
          classes: {
            circle: classes.avatarIcon
          }
        }, /*#__PURE__*/react.createElement(SearchSharp/* default */.c, {
          fontSize: "small"
        })),
        label: searchAnnotationsCount,
        className: classnames_default()(classes.searchChip),
        size: "small"
      }), (annotationsCount || 0) > 0 && /*#__PURE__*/react.createElement(Chip/* default */.c, {
        avatar: /*#__PURE__*/react.createElement(Avatar_Avatar, {
          className: classes.avatar,
          classes: {
            circle: classes.avatarIcon
          }
        }, /*#__PURE__*/react.createElement(CommentSharp/* default */.c, {
...
var selectors_annotations = __webpack_require__(89376);
...
var mapStateToProps = function mapStateToProps(state, _ref) {
  ...
  var currentCanvas = (0,canvases/* getCurrentCanvas */.k1)(state, {
    windowId: windowId
  });
  var searchAnnotations = (0,searches/* getSearchAnnotationsForWindow */.w7)(state, {
    windowId: windowId
  });
  ...
  var hasOpenAnnotationsWindow = (0,companionWindows/* getCompanionWindowsForContent */.aA)(state, {
    content: 'annotations',
    windowId: windowId
  }).length > 0;
  return {
    annotationsCount: function () {
      ...
      var annotations = (0,selectors_annotations/* getPresentAnnotationsOnSelectedCanvases */.ER)(state, {
        canvasId: canvas.id
      });
    ...
    config: (0,config/* getConfig */.eE)(state).galleryView,
...
var mapDispatchToProps = function mapDispatchToProps(dispatch, _ref2) {
  ...
  return {
    focusOnCanvas: function focusOnCanvas() {
      return dispatch(actions_window/* setWindowViewType */.Gk(windowId, 'single'));
    },
    requestCanvasAnnotations: function requestCanvasAnnotations() {
      return dispatch(annotation/* requestCanvasAnnotations */.S4(windowId, canvas.id));
    },
    setCanvas: function setCanvas() {
      for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }
      return dispatch(actions_canvas/* setCanvas */.I$.apply(actions, [windowId].concat(args)));
    }
  };
};
var enhance = (0,redux/* compose */.Jn)((0,es/* connect */.Ul)(mapStateToProps, mapDispatchToProps), (0,withStyles/* default */.c)(GalleryViewThumbnail_styles) // further HOC go here
);
/* harmony default export */ var containers_GalleryViewThumbnail = (enhance(GalleryViewThumbnail));
;// CONCATENATED MODULE: ./node_modules/mirador/dist/es/src/components/GalleryView.js
function GalleryView_classCallCheck(instance, Constructor) {
  if (!(instance instanceof Constructor)) {
    throw new TypeError("Cannot call a class as a function");
  }
}
function GalleryView_defineProperties(target, props) {
  for (var i = 0; i < props.length; i++) {
    var descriptor = props[i];
    descriptor.enumerable = descriptor.enumerable || false;
    descriptor.configurable = true;
...
function GalleryView_createClass(Constructor, protoProps, staticProps) {
  if (protoProps) GalleryView_defineProperties(Constructor.prototype, protoProps);
  if (staticProps) GalleryView_defineProperties(Constructor, staticProps);
  return Constructor;
}
function GalleryView_inherits(subClass, superClass) {
  if (typeof superClass !== "function" && superClass !== null) {
    throw new TypeError("Super expression must either be null or a function");
  }
  subClass.prototype = Object.create(superClass && superClass.prototype, {
  ...
  if (superClass) GalleryView_setPrototypeOf(subClass, superClass);
}
function GalleryView_setPrototypeOf(o, p) {
  GalleryView_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) {
    o.__proto__ = p;
    return o;
  };
  return GalleryView_setPrototypeOf(o, p);
}
function GalleryView_createSuper(Derived) {
  var hasNativeReflectConstruct = GalleryView_isNativeReflectConstruct();
  return function _createSuperInternal() {
    var Super = GalleryView_getPrototypeOf(Derived),
      result;
    if (hasNativeReflectConstruct) {
      var NewTarget = GalleryView_getPrototypeOf(this).constructor;
      result = Reflect.construct(Super, arguments, NewTarget);
    } else {
      result = Super.apply(this, arguments);
    }
    return GalleryView_possibleConstructorReturn(this, result);
  };
}
function GalleryView_possibleConstructorReturn(self, call) {
  if (call && (typeof call === "object" || typeof call === "function")) {
    return call;
  } else if (call !== void 0) {
    throw new TypeError("Derived constructors may only return object or undefined");
  }
  return GalleryView_assertThisInitialized(self);
}
function GalleryView_assertThisInitialized(self) {
  if (self === void 0) {
    throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
  }
  return self;
}
function GalleryView_isNativeReflectConstruct() {
  if (typeof Reflect === "undefined" || !Reflect.construct) return false;
  if (Reflect.construct.sham) return false;
  if (typeof Proxy === "function") return true;
  try {
...
function GalleryView_getPrototypeOf(o) {
  GalleryView_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) {
    return o.__proto__ || Object.getPrototypeOf(o);
  };
  return GalleryView_getPrototypeOf(o);
}
...
var GalleryView_mapStateToProps = function mapStateToProps(state, _ref) {
  ...
  return {
    canvases: (0,canvases/* getCanvases */.UF)(state, {
      windowId: windowId
    }),
...
var GalleryView_enhance = (0,redux/* compose */.Jn)((0,withStyles/* default */.c)(GalleryView_styles), (0,es/* connect */.Ul)(GalleryView_mapStateToProps), (0,withPlugins/* withPlugins */.A)('GalleryView') // further HOC go here
);
/* harmony default export */ var containers_GalleryView = (GalleryView_enhance(GalleryView));
